...
//            );
    ...
    public CarDto(String carNum, String carName, String carCategory, String carFeature, int carPrefComfort, int carPrefWeight, int carPrefPassenger, String carImg) {
        this.carNum = carNum;
